---
title: "MCP server"
description: "The Autousers MCP server exposes 39 tools so you can create evaluations, run autousers, and read results directly from any MCP-aware AI client."
---
